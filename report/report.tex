...
Floreano in \cite{floreano2008neuroevolution} classifies three classes of genetic encoding of an \gls{ann}: direct, developmental and implicit.
...
Neuroevolution has been applied with success in different domains like video games \cite{stanley2005real} \cite{hausknecht2014neuroevolution}, collective self-organization \cite{nitschke2008neuro} \cite{nitschke2010collective} and common robotics tasks %TODO add citations
...
Complexification of the controllers was managed by increasing the size of the \gls{ann} gradually during the evolution run.
...
\vspace{0.5em}
\subsubsection{Homo vs Etero}
We first consider two experiments that relate to $H_1$, here the IV is the controller type (homo or etero).
