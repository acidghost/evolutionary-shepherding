...
We first consider two experiments that relate to $H_1$. Here the independent variable is the controller type (homo or heterogeneous).
Figure~\ref{fig:2v1_homo_vs_hetero} reports the performance on a scenario with two shepherds and one sheep, while Figure~\ref{fig:3v1_homo_vs_hetero} reports a performance on a scenario with three shepherds and one sheep.
