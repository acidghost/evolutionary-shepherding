...
\textbf{TODO: how exactly are the controllers evaluated? For an agent in subpopulation 0, choose best from subpopulation 1? }
...
$\displaystyle fitness = \sum_{timeSteps=1}^{1500 or stop}(individualDistance - groupMultiplier * sheepRatio)_{timeSteps}$
