...
Note that the first and the second run involves respectively two and three shepherds against one sheep.
The results are reported in Figure~\ref{fig:2v1_homo_vs_hetero} for the former case, while Figure~\ref{fig:3v1_homo_vs_hetero} the latter.
...
Moreover, we perform \textit{t}-test on the means of the homogeneous and heterogeneous trials, which produced a \textit{p}-value $\ll0.5$ for both cases.
