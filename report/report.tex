...
Given heterogeneous controllers, the sheep to shepherd ratio cannot predict the effectiveness shepherds will have in herding sheep. Different scenarios proved to be statistically different, with scenarios with two shepherds herding one sheep and three shepherds herding two sheep being optimal for herding. 

These findings support and expand Potter et al.'s work ~\cite{potter2001heterogeneity}. We show that by increasing task complexity alone, there is not need to implement heterogeneous controllers. Having more adaptable sheep in fact weakens heterogeneity in the scenarios we explored, while varying the sheep to dog ratio is uninformative of the shepherds fitness scores. 
%TODO discussion
% discuss why performance is noisy
\newpage
\printbibliography
