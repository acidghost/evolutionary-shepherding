...
Similarly, the chart in Figure ~\ref{fig:ratios_threeShepherd} shows that the optimal scenario is three shepherds herding two sheep. Since it displays the highes corralled ratio. 
